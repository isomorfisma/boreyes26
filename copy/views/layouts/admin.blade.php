    ...
    <div class="min-h-screen" x-data="{ sidebarOpen: true }">
        ...
        >
            ...
            <nav class="px-4 py-5 space-y-2 overflow-y-auto flex-1">
                ...
                <!-- Pre-Elimination Essays -->
                <a href="{{ route('admin.essays.index') }}"
                   class="flex items-center space-x-3 px-3.5 py-2.5 text-white/80 hover:bg-white/10 rounded-xl transition font-garet {{ request()->routeIs('admin.essays.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    <span class="text-[13px]">Pre-Elim Essays</span>
                </a>
