        ...
        >
            ...
            <nav class="px-4 py-5 space-y-2 overflow-y-auto flex-1">
                ...
                <a href="{{ route('admin.competitions.index') }}"
                   class="flex items-center space-x-3 px-3.5 py-2.5 text-white/80 hover:bg-white/10 rounded-xl transition font-garet {{ request()->routeIs('admin.competitions.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                    </svg>
                    <span class="text-[13px]">Competitions</span>
                </a>

                <!-- Teams -->
                <a href="{{ route('admin.teams.index') }}"
                   class="flex items-center space-x-3 px-3.5 py-2.5 text-white/80 hover:bg-white/10 rounded-xl transition font-garet {{ request()->routeIs('admin.teams.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.event-programs.index') }}"
                   class="flex items-center space-x-3 px-3.5 py-2.5 text-white/80 hover:bg-white/10 rounded-xl transition font-garet {{ request()->routeIs('admin.event-programs.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                    </svg>
                    <span class="text-[13px]">Event Programs</span>
                </a>
                -->
                <!-- SEO Settings -->
                <a href="{{ route('admin.seo.index') }}"
                   class="flex items-center space-x-3 px-3.5 py-2.5 text-white/80 hover:bg-white/10 rounded-xl transition font-garet {{ request()->routeIs('admin.seo.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>
                    <span class="text-[13px]">SEO Settings</span>
                </a>

                <!-- Email Settings -->
                <a href="{{ route('admin.email.index') }}"
                   class="flex items-center space-x-3 px-3.5 py-2.5 text-white/80 hover:bg-white/10 rounded-xl transition font-garet {{ request()->routeIs('admin.email.*') ? 'bg-white/20 text-white shadow-lg' : '' }}">
                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                    </svg>
                    <span class="text-[13px]">Email Settings</span>
                </a>
