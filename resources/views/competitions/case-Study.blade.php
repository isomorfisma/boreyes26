...
@php
  $competition = [
    ...
    'status' => 'COMING SOON', // OPEN | CLOSED | COMING SOON
  ...
  $others = [
    [
      ...
      'image' => asset('assets/img/competitions/business-case.jpg')
    ],
    [
      ...
      'image' => asset('assets/img/competitions/smart-competition.jpg')
    ],
    [
      ...
      'image' => asset('assets/img/competitions/paper-poster.jpg')
    ],
    [
      ...
      'image' => asset('assets/img/competitions/plan-of-development.jpg')
    ],
  ];
@endphp
