...
<body class="overflow-x-hidden">
    <section class="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-[#6F97B6] via-[#8CCDCF] to-[#D6EBDF] overflow-hidden">
        ...
        <!-- Middle Section -->
        <div class="absolute top-1/4 right-1/3 w-13 sm:w-16 h-13 sm:h-16 opacity-75 animate-float-delayed" style="animation-delay: 0.6s;">
            <svg viewBox="0 0 100 100" class="w-full h-full drop-shadow-[0_0_18px_rgba(111,151,182,0.9)]">
                <path d="M50 0 L55 45 L100 50 L55 55 L50 100 L45 55 L0 50 L45 45 Z" fill="#6F97B6"/>
            </svg>
        </div>
     
        <div class="absolute top-1/2 right-1/5 w-11 sm:w-14 h-11 sm:h-14 opacity-70 animate-float-delayed" style="animation-delay: 1.2s;">
            <svg viewBox="0 0 100 100" class="w-full h-full drop-shadow-[0_0_16px_rgba(197,230,201,0.9)]">
                <path d="M50 0 L55 45 L100 50 L55 55 L50 100 L45 55 L0 50 L45 45 Z" fill="#C5E6C9"/>
            </svg>
        </div>
        <div class="absolute top-1/3 right-3/4 w-12 sm:w-15 h-12 sm:h-15 opacity-75 animate-float" style="animation-delay: 0.8s;">
