...
<section class="py-8 sm:py-12 bg-[#F8FBFC] min-h-screen">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Team Status Banner (if user has competition) -->
            ...
            <div class="p-4 sm:p-6">
                <div class="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="font-helvetica font-black text-white text-base sm:text-lg truncate">{{ $user->team_name }}</h3>
                        <p class="text-white/80 text-xs sm:text-sm font-garet mt-0.5 truncate">{{ $competition->name }}</p>
                    </div>
                    <a href="/dashboard" class="flex-shrink-0 px-3 sm:px-4 py-2 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white text-xs sm:text-sm font-helvetica font-black rounded-lg transition-all duration-300 border border-white/30">
                        View Team
                    </a>
                </div>
            </div>
