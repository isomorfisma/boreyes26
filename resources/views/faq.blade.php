        ...
        <div class="mt-16 gsap-faq-contact bg-gradient-to-br from-white to-[#F8FBFC] rounded-2xl p-8 border border-[#0F4C82]/10 shadow-xl">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center gsap-faq-contact-buttons">
                    ...
                    <a href="https://wa.me/6281224792630" target="_blank" class="gsap-faq-contact-btn inline-flex items-center justify-center px-8 py-4 bg-white text-[#0F4C82] font-helvetica font-black rounded-xl border-2 border-[#0F4C82]/30 hover:bg-[#0F4C82] hover:text-white shadow-xl hover:shadow-2xl transition-all duration-300">
