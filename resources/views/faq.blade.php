...
<section class="relative bg-gradient-to-b from-[#6F97B6] via-[#8CCDCF] to-[#D6EBDF] text-white overflow-hidden pt-16 sm:pt-20 lg:pt-24 pb-16 sm:pb-20 lg:pb-24 scroll-mt-20">
    ...
    <div class="absolute bottom-0 left-0 w-1/4 h-80 opacity-15 pointer-events-none animate-sway-reverse" style="background-image: url('/path/to/palm-shadow.png'); background-size: contain; background-position: bottom left; background-repeat: no-repeat; transform: scaleX(-1);"></div>
        ...
        <div class="space-y-4" x-data="{ activeIndex: null }">
                ...
                <div x-show="activeIndex === 0"
                    ...
                    <div class="px-6 pb-6">
                        <div class="pt-2 border-t border-[#0F4C82]/10">
                            <p class="text-[#374151] leading-relaxed font-garet pt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 border border-[#0F4C82]/10 hover:border-[#D3EB9F]/60"
                ...
                <div x-show="activeIndex === 1"
                    ...
                    <div class="px-6 pb-6">
                        <div class="pt-2 border-t border-[#0F4C82]/10">
                            <p class="text-[#374151] leading-relaxed font-garet pt-4">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 border border-[#0F4C82]/10 hover:border-[#D3EB9F]/60"
                ...
                <div x-show="activeIndex === 2"
                    ...
                    <div class="px-6 pb-6">
                        <div class="pt-2 border-t border-[#0F4C82]/10">
                            <p class="text-[#374151] leading-relaxed font-garet pt-4">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 border border-[#0F4C82]/10 hover:border-[#D3EB9F]/60"
                ...
                <div x-show="activeIndex === 3"
                    ...
                    <div class="px-6 pb-6">
                        <div class="pt-2 border-t border-[#0F4C82]/10">
                            <p class="text-[#374151] leading-relaxed font-garet pt-4">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 border border-[#0F4C82]/10 hover:border-[#D3EB9F]/60"
                ...
                <div x-show="activeIndex === 4"
                    ...
                    <div class="px-6 pb-6">
                        <div class="pt-2 border-t border-[#0F4C82]/10">
                            <p class="text-[#374151] leading-relaxed font-garet pt-4">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-16 bg-gradient-to-br from-white to-[#F8FBFC] rounded-2xl p-8 border border-[#0F4C82]/10 shadow-xl animate-fade-in-up animation-delay-200">
            <div class="text-center">
               ...
               <h3 class="text-2xl sm:text-3xl font-black text-[#0F4C82] mb-3 font-helvetica">Still Have Questions?</h3>
                <p class="text-[#6B7280] mb-8 font-garet text-base">Feel free to reach out to us!</p>
...
<section class="py-20 sm:py-32 bg-gradient-to-b from-[#6F97B6] via-[#8CCDCF] to-[#D6EBDF] text-white relative overflow-hidden">
    ...
    <!-- Palm Shadows -->
    <div class="absolute top-0 left-0 w-1/3 h-full opacity-15 animate-sway" style="background-image: url('/path/to/palm-shadow.png'); background-size: contain; background-position: top left; background-repeat: no-repeat; transform: scaleX(-1);"></div>
    <div class="absolute bottom-0 right-0 w-1/3 h-full opacity-15 animate-sway-reverse" style="background-image: url('/path/to/palm-shadow.png'); background-size: contain; background-position: bottom right; background-repeat: no-repeat;"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <div class="animate-fade-in-up">
            ...
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-helvetica font-black tracking-tighter mb-6 text-white drop-shadow-[0_4px_8px_rgba(0,0,0,0.3)]" style="text-shadow: 2px 2px 4px rgba(15,76,130,0.5), -1px -1px 2px rgba(15,76,130,0.3);">
                Mulai Perjalananmu di Event 2026
            </h2>
            ...
            <div class="flex flex-col sm:flex-row gap-5 justify-center">
                ...
                <a href="" class="group inline-flex items-center justify-center px-10 py-5 bg-white/10 backdrop-blur-md border-3 border-white text-white font-helvetica font-black rounded-2xl hover:bg-white hover:text-[#0F4C82] shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 text-base min-h-[60px]">
